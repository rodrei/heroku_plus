...
After you have created your identities, send the identity of each public key to Heroku:
...
You should see "You can only access Heroku by ssh via git push and pull commands." at the bottom. If you do look for the correct email above at the end of a line like "debug1: Remote: Forced command: /home/git/bin/git_proxy <email>"
...
Full usage is displayed below:
  ...
  -p, --pass COMMAND               Pass command to Heroku with current app info.
  -m, --migrate                    Migrate remote database and restart Heroku server with current app info.
